// Package skill implements the google-cli skill subcommands: installing,
...
// embedded google-cli agent-skill bundle.
func NewCmd(cfg *app.Config) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "skill",
		Short: "Manage the google-cli agent-skill bundle for AI agents",
		Long: "Manage the google-cli agent-skill bundle: install it into the skills " +
