...
func TestGetJSON(t *testing.T) {
	...
	out := runCmd(t, newLeafCmd(newGetCmd, svc, "json"), "msg_1")
...
func TestGetTable(t *testing.T) {
	svc := &fakeService{messages: []*gmail.Message{seedDetailMessage()}}
	out := runCmd(t, newLeafCmd(newGetCmd, svc, "table"), "msg_1")
...
func TestGetRaw(t *testing.T) {
	svc := &fakeService{messages: []*gmail.Message{seedDetailMessage()}}
	out := runCmd(t, newLeafCmd(newGetCmd, svc, "json"), "msg_1", "--raw")
...
func TestGetMissingHeaders(t *testing.T) {
	...
	out := runCmd(t, newLeafCmd(newGetCmd, svc, "json"), "msg_2")
...
func TestGetNotFound(t *testing.T) {
	svc := &fakeService{messages: seedMessages()}
	_, err := runCmdErr(t, newLeafCmd(newGetCmd, svc, "json"), "msg_404")
...
func TestGetPropagatesAPIError(t *testing.T) {
	...
	_, err := runCmdErr(t, newLeafCmd(newGetCmd, svc, "json"), "msg_1")
